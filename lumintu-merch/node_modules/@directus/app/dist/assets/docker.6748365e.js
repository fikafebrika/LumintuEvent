import{r as l,p as r,q as c,w as o,B as s,P as e}from"./vendor.a626ab9c.js";const i=s("div",{class:"markdown-body"},[s("p",null,[e("Directus is published to both "),s("a",{href:"https://hub.docker.com/r/directus/directus",target:"_blank",rel:"noopener noreferrer"},"DockerHub"),e(" and "),s("a",{href:"https://github.com/orgs/directus/packages/container/package/directus",target:"_blank",rel:"noopener noreferrer"},"GitHub Packages"),e(" under "),s("code",null,"directus/directus"),e(". To use the Directus image from DockerHub, run:")]),s("pre",null,[s("code",{class:"language-bash"},[s("span",{class:"hljs-comment"},"# Make sure to change sensitive values (KEY, SECRET, ...) in production"),e(`
...
`)])]),s("div",{class:"warning hint"},[s("div",{class:"hint-title"},"Change In Naming of Docker Tags"),s("p",null,"Before 9.0.0-rc.84 the Docker tags were prefixed by a \u201Cv\u201D - e.g. v9.0.0-rc.83.")]),s("h3",{id:"create-admin-user-using-docker"},[e("Create admin user using docker "),s("a",{class:"header-anchor",href:"#create-admin-user-using-docker"},"#")]),s("p",null,"The published Docker image will automatically populate the database, and create a user. To configure the email/password for this first user, pass the following env vars:"),s("pre",null,[s("code",{class:"language-bash"},[e("ADMIN_EMAIL="),s("span",{class:"hljs-string"},'"admin@example.com"'),e(`
...
`),s("span",{class:"hljs-attr"},"services:"),e(`
  `),s("span",{class:"hljs-attr"},"database:"),e(`
    ...
    `),s("span",{class:"hljs-attr"},"image:"),e(),s("span",{class:"hljs-string"},"postgres:12"),e(`
