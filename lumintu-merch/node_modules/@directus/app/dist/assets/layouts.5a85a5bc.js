import{r as n,p as c,q as r,w as o,B as e,t as u,P as t}from"./vendor.a626ab9c.js";const d={class:"markdown-body"},h=t("Custom Layouts allow for building new ways to view or interact with Items via the Collection Detail pages. "),p=t("Learn more about Layouts"),y=t("."),m=e("h2",{id:"1.-setup-the-boilerplate"},[t("1. Setup the Boilerplate "),e("a",{class:"header-anchor",href:"#1.-setup-the-boilerplate"},"#")],-1),_=e("p",null,"Every layout is a standalone \u201Cpackage\u201D that contains at least a metadata file and a Vue component. We recommend using the following file structure:",-1),f=e("pre",null,[e("code",null,`src/
	index.js
	layout.vue
