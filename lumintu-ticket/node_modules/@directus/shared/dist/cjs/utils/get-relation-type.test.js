...
describe('getRelationType', () => {
    it('returns m2o when relation is the same as collection and field', () => {
        ...
        expect((0, _1.getRelationType)({ relation: mockRelation, collection: 'test', field: 'testField' })).toBe('m2o');
    });
    it('returns m2a when one_allowed_collections and one_collection_field are defined', () => {
        ...
        expect((0, _1.getRelationType)({ relation: mockRelation, collection: 'test', field: 'testField' })).toBe('m2a');
    });
    it('returns o2m when related_collection is the same as collection and field', () => {
        ...
        expect((0, _1.getRelationType)({ relation: mockRelation, collection: 'test2', field: 'testField' })).toBe('o2m');
    });
});
