...
describe('define-extensions', () => {
    ...
    it('return an interface config', () => {
        expect((0, _1.defineInterface)(interfaceConfig)).toBe(interfaceConfig);
    });
    it('return a display config', () => {
        expect((0, _1.defineDisplay)(displayConfig)).toBe(displayConfig);
    });
    it('return a layout config', () => {
        expect((0, _1.defineLayout)(layoutConfig)).toBe(layoutConfig);
    });
    it('return a config', () => {
        expect((0, _1.defineModule)(interfaceConfig)).toBe(interfaceConfig);
    });
    it('return a hook config', () => {
        expect((0, _1.defineHook)(hookHandler)).toBe(hookHandler);
    });
    it('return an endpoint config', () => {
        expect((0, _1.defineEndpoint)(endpointConfig)).toBe(endpointConfig);
    });
});
