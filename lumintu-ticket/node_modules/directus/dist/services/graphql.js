    ...
    injectSystemResolvers(schemaComposer, { CreateCollectionTypes, ReadCollectionTypes, DeleteCollectionTypes, }, schema) {
        ...
        schemaComposer.Query.addFields({
            extensions: {
                ...
                resolve: async () => ({
                    interfaces: (0, extensions_1.listExtensions)('interface'),
                    displays: (0, extensions_1.listExtensions)('display'),
                    layouts: (0, extensions_1.listExtensions)('layout'),
                    modules: (0, extensions_1.listExtensions)('module'),
                }),
            },
            server_specs_oas: {
                type: graphql_compose_1.GraphQLJSON,
