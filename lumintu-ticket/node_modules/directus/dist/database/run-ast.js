...
async function runAST(originalAST, schema, options) {
    ...
    async function run(collection, children, query) {
        ...
        const dbQuery = await getDBQuery(schema, knex, collection, fieldNodes, query, options === null || options === void 0 ? void 0 : options.nested);
...
function getDBQuery(schema, knex, table, fieldNodes, query, nested) {
            ...
            nestedNode.query = {
                ...
                filter: {
                    ...
                    [schema.collections[nestedNode.relation.related_collection].primary]: {
                        _in: (0, lodash_1.uniq)(parentItems.map((res) => res[nestedNode.relation.field])).filter((id) => id),
                    },
                },
            };
        }
            ...
            nestedNode.query = {
                ...
                filter: {
                    ...
                    [nestedNode.relation.field]: {
                        _in: (0, lodash_1.uniq)(parentItems.map((res) => res[nestedNode.parentKey])).filter((id) => id),
                    },
                },
            };
        }
                        ...
                        _and: [
                            nestedNode.query[relatedCollection].filter,
                            {
                                [nestedNode.relatedKey[relatedCollection]]: {
                                    _in: (0, lodash_1.uniq)(keysPerCollection[relatedCollection]),
                                },
                            },
                        ].filter((f) => f),
                    },
...
function mergeWithParentItems(schema, nestedItem, parentItem, nestedNode, nested) {
    var _a, _b;
