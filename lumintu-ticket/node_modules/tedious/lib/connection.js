    ...
    if (config.authentication !== undefined) {
      ...
      if (type === 'ntlm') {
        ...
        if (options.msiEndpoint !== undefined && options.msiEndpoint !== process.env.MSI_ENDPOINT) {
          deprecate('The `config.authentication.options.msiEndpoint` property is deprecated and will be removed in the next major release. ' + 'To silence this message, ensure that `process.env.MSI_ENDPOINT` and `config.authentication.options.msiEndpoint` are set to the same value.');
        }
        ...
        if (options.msiSecret !== undefined && options.msiSecret !== process.env.MSI_SECRET) {
          deprecate('The `config.authentication.options.msiSecret` property is deprecated and will be removed in the next major release. ' + 'To silence this message, ensure that `process.env.MSI_SECRET` and `config.authentication.options.msiSecret` are set to the same value.');
        }
